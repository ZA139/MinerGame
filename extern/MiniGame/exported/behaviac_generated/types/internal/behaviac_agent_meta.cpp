...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(2680877555u);
			...
			// AgentWithMessage
			meta = BEHAVIAC_NEW AgentMeta(3802280444u);
			AgentMeta::GetAgentMetas()[2356440319u] = meta;
			meta->RegisterMemberProperty(2325813856u, BEHAVIAC_NEW CMemberProperty< bool >("isHandlingMessage", Set_AgentWithMessage_isHandlingMessage, Get_AgentWithMessage_isHandlingMessage));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_AgentWithMessage_LogMessage));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			// Miner
			meta = BEHAVIAC_NEW AgentMeta(1259672074u);
			AgentMeta::GetAgentMetas()[2438935762u] = meta;
			meta->RegisterMemberProperty(418605588u, BEHAVIAC_NEW CMemberProperty< unsigned int >("GoldCarried", Set_Miner_GoldCarried, Get_Miner_GoldCarried));
			meta->RegisterMemberProperty(2325813856u, BEHAVIAC_NEW CMemberProperty< bool >("isHandlingMessage", Set_AgentWithMessage_isHandlingMessage, Get_AgentWithMessage_isHandlingMessage));
			meta->RegisterMemberProperty(3335903329u, BEHAVIAC_NEW CMemberProperty< unsigned int >("ThirstyTimer", Set_Miner_ThirstyTimer, Get_Miner_ThirstyTimer));
			meta->RegisterMemberProperty(17048731u, BEHAVIAC_NEW CMemberProperty< unsigned int >("TodayGainedGold", Set_Miner_TodayGainedGold, Get_Miner_TodayGainedGold));
			meta->RegisterMemberProperty(2726490193u, BEHAVIAC_NEW CMemberProperty< unsigned int >("TotalMoney", Set_Miner_TotalMoney, Get_Miner_TotalMoney));
			meta->RegisterMethod(3834672422u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_Miner_EnterMineAndDigForNugget));
			meta->RegisterMethod(4022599832u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_Miner_GoToBank));
			meta->RegisterMethod(1521451608u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_Miner_GoToBarDrinkSomeWhiskey));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_Miner_LogMessage));
			meta->RegisterMethod(1837055386u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_Miner_Rest));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			// Wife
			meta = BEHAVIAC_NEW AgentMeta(4234829567u);
			AgentMeta::GetAgentMetas()[2793230297u] = meta;
			meta->RegisterMemberProperty(2325813856u, BEHAVIAC_NEW CMemberProperty< bool >("isHandlingMessage", Set_AgentWithMessage_isHandlingMessage, Get_AgentWithMessage_isHandlingMessage));
			meta->RegisterMemberProperty(141551562u, BEHAVIAC_NEW CMemberProperty< bool >("isWannaGotoBathRoom", Set_Wife_isWannaGotoBathRoom, Get_Wife_isWannaGotoBathRoom));
			meta->RegisterMethod(3557017733u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_Wife_DoHomeWork));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_Wife_LogMessage));
			meta->RegisterMethod(2400561428u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_Wife_Peeing));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta::Register<AgentWithMessage>("AgentWithMessage");
			AgentMeta::Register<Miner>("Miner");
			AgentMeta::Register<Wife>("Wife");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<AgentWithMessage>("AgentWithMessage");
			AgentMeta::UnRegister<Miner>("Miner");
			AgentMeta::UnRegister<Wife>("Wife");
